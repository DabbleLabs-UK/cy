...
export const REFERENCE_EVENT_ARCHETYPES = Object.freeze([
  ...
  { id: 'cell_search', family: 'custody', world: { physical: { injury: 'none', nociceptive_impact: 'none' }, situation: { possible_harm: 'possible', uncertainty: 'present', control: 'none', predictability: 'low', goal_obstruction: 'present', agency: 'officer', intent: 'unknown', resolution_status: 'resolved' }, context: { location: 'cell' } }, observation: { modality: 'direct', certainty: 'certain' } },
  { id: 'lockdown', family: 'custody', world: { situation: { possible_harm: UNKNOWN, uncertainty: 'present', control: 'none', predictability: 'low', goal_obstruction: 'present', agency: 'institution', intent: 'unknown', resolution_status: 'unresolved' }, context: { location: 'wing' } }, observation: { modality: 'direct', certainty: 'certain' } },
  { id: 'cancelled_activity', family: 'routine', world: { situation: { control: 'none', predictability: 'low', goal_obstruction: 'present', agency: 'institution', responsibility_evidence: UNKNOWN, intent: UNKNOWN, resolution_status: 'resolved', deprivation_outcome: 'missed' } }, observation: { modality: 'direct', certainty: 'certain' } },
  { id: 'minor_injury', family: 'physical', world: { physical: { injury: 'minor', nociceptive_impact: 'minor', physical_discomfort: 'present' }, situation: { possible_harm: 'minor', resolution_status: UNKNOWN } }, observation: { modality: 'direct', certainty: 'certain' } },
  ...
  { id: 'friendly_interaction', family: 'social', world: { situation: { possible_harm: 'none', social_contact: 'present', social_contact_quality: 'supportive', rejection_support: 'support', intent: 'supportive', resolution_status: 'resolved' } }, observation: { modality: 'direct', certainty: 'probable' } },
  { id: 'hostile_interaction', family: 'social', world: { situation: { possible_harm: 'possible', social_contact: 'present', social_contact_quality: 'hostile', rejection_support: 'rejection', intent: 'hostile', resolution_status: UNKNOWN } }, observation: { modality: 'direct', certainty: 'probable' } },
  { id: 'social_rejection', family: 'social', world: { situation: { social_contact: 'attempted', social_contact_quality: 'rejecting', rejection_support: 'rejection', intent: 'ambiguous', resolution_status: 'resolved' } }, observation: { modality: 'direct', certainty: 'certain' } },
  ...
  { id: 'officer_instruction', family: 'custody', world: { situation: { control: 'limited', agency: 'officer', responsibility_evidence: 'present', intent: 'neutral', resolution_status: 'resolved' } }, observation: { modality: 'direct', certainty: 'certain' } },
