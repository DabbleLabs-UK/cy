...
| `postcard_in`  | `{ id, from, body, image, attrib, visit_count, promoted }` - a delivered postcard; `promoted` means it was selected from the fan-mail bag. The private visitor ID is never published. |
