...
| `experienced-state.js` legacy metrics | Anxiety, Arousal, legacy Pain, Hunger, Fatigue, Loneliness, Anger and Rumination | No prose, expressive choice, timing, sampling, length, drawing or perception effect. Legacy Pain and Loneliness are diagnostics-only and are not primary visitor metrics; remaining public legacy histories are labelled provisional. |
